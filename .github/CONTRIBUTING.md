...
* Create an [issue](https://github.com/framework7io/framework7-vue/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/framework7io/framework7-vue/issues), assuming one does not already exist.
  * Clearly describe the issue including steps to reproduce when it is a bug.
  * Make sure you fill in the earliest version that you know has the issue.
  * Include live link or JSFiddle/Codepen link with the issue if you want it to be discovered and resolved asap. We have one for you [JSFiddle](https://jsfiddle.net/nolimits4web/jcwzqovz/)
