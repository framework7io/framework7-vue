<template>
  <li>
    <a v-if="title"
      ...
      :data-popup="typeof openPopover === 'string' ? openPopover : false"
      :data-popover="typeof openPicker === 'string' ? openPicker : false"
      :data-picker="typeof openLoginScreen === 'string' ? openLoginScreen : false"
      :data-login-screen="typeof openSortable === 'string' ? openSortable : false"
      :data-sortable="typeof toggleSortable === 'string' ? toggleSortable : false"
